...
# from maddpg.utils.make_env import make_env
from maddpg import *
...
writer = SummaryWriter('./logMADDPG')
...
def run(config):
    ...
    for ep_i in range(0, config.n_episodes, config.n_rollout_threads):
        ...
        for et_i in range(config.episode_length):
            ...
            total_reward += sum(list(rewards.reshape(-1)))
        ...
        writer.add_scalar("reward", total_reward, ep_i)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--env_id", help="Name of environment",default="none")
